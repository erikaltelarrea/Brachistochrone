...
```math
		...
		\right.
```
For the variants $A$ and $B$, we will also consider a non-uniform (NU) discretisation of the axis, defining $x[i]=a*(i/n)^2$ and $y[i]=b*(i/n)^2+tol$ $\foral i=0,...,n$, respectively.
